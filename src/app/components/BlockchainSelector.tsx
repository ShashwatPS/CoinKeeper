...
const BlockchainSelector: React.FC<BlockchainSelectorProps> = ({ selectBlockchain }) => {
    return (
        <div className="flex flex-col w-full h-full gap-6 pt-11">
            <div>
            <h1 className="tracking-tighter text-4xl md:text-5xl font-black"> HD Wallet</h1>
            <h3 className="text-primary/80 text-lg md:text-xl">Choose a blockchain to get started.</h3>
            </div>
